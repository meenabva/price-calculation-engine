...
public class TaxDriverImpactCalculator implements DriverImpactCalculator {

    private final Logger log = LoggerFactory.getLogger(TaxDriverImpactCalculator.class);
